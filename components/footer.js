...
export default class Footer extends Component {
  render() {
    ...
    return (
      <footer className={'mdl-grid ' + styles.footer} style={{backgroundColor: '#363636', backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom left', backgroundSize: '100px', margin: 0, color: '#fff', paddingBottom: 40}}>
